...
# Boresch angle and dihedral values (in deg)
theta_a_0 = 133.0
theta_b_0 = 115.0
phi_a_0 = -36.0
phi_b_0 = -133.0
...
k_boresch = 100.0*kilocalories_per_mole/radians**2
...
bv = BiasVariable(dist, cv_min, cv_max, 0.025)
...
# adding helical torsional restraints
...
k_upper = 1000.0*kilojoules_per_mole/nanometers**2
upper_wall = 6.0*nanometers
upper_wall_rest = CustomCentroidBondForce(2, '0.5*k_upper*max(distance(g1,g2) - upper_wall, 0)^2')
